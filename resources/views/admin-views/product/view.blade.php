                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                ...
                                <p> de {{$product->reviews->count()}} críticas
                            ...
                            <td>
                                <a class="d-flex align-items-center"
                                   href="{{route('admin.customer.view',[$review['customer_id']])}}">
                                    ...
                                    <div class="ml-3">
                                    <span class="d-block h5 text-hover-success mb-0">{{$review->customer['f_name']." ".$review->customer['l_name']}} <i
                                            class="tio-verified text-success" data-toggle="tooltip" data-placement="top"
