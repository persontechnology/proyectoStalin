                        ...
                        <div class="card-body text-light">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    @endphp
                                    <div
                                        class="for-card-count">{{\App\CPU\BackEndHelper::usd_to_currency($wallet->balance)}}</div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div
                                    class="for-card-count">{{\App\CPU\BackEndHelper::usd_to_currency($wallet->withdrawn) }}</div>
                            </div>
                            <div class="col-auto for-margin">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div
                                    class="for-card-count">{{ \App\CPU\BackEndHelper::usd_to_currency($wallet->balance+$wallet->withdrawn )}}</div>
                            </div>
                            <div class="col-auto for-margin">
